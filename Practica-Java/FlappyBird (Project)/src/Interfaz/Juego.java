...
public class Juego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelImage1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/F1.jpg"))); // NOI18N
        ...
        jSuelo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/carretera.jpg"))); // NOI18N
        ...
        jFlappy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/P2.png"))); // NOI18N
        ...
        jFlappy.setBounds(90, 80, 94, 74);

        jTubo_arriba1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/E1.png"))); // NOI18N
        panelImage1.add(jTubo_arriba1);
        jTubo_arriba1.setBounds(70, -120, 52, 320);

        jTubo_abajo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/E2.png"))); // NOI18N
        panelImage1.add(jTubo_abajo1);
        jTubo_abajo1.setBounds(70, 280, 52, 320);

        jTubo_arriba2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/E1.png"))); // NOI18N
        panelImage1.add(jTubo_arriba2);
        jTubo_arriba2.setBounds(290, -120, 52, 320);

        jTubo_abajo2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/E2.png"))); // NOI18N
    ...
    public void Empezar() {
        ...
        this.setTitle("FLAPPY CAR - " + nombre);
    }
